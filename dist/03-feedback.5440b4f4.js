...
var _apiJs = require("./fn03/api.js");
var _apiJsDefault = parcelHelpers.interopDefault(_apiJs);
const feedback_form_state = {};
const form = document.querySelector(".feedback-form");
console.log(form.name);
form.addEventListener("input", (0, _apiJsDefault.default)(function(event) {
    feedback_form_state[event.target.name] = event.target.value;
    localStorage.setItem("feedback-form-state", JSON.stringify(feedback_form_state));
}, 1000));
...
},{"./fn03/api.js":"4yTIS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4yTIS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var throttle = require("lodash.throttle");
exports.default = throttle = require("lodash.throttle");
